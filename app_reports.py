...
def generateMonthlyReport(userID, year=None):
    ...
    spending_month_chart = app_dashboard.getMonthlySpending(userID, year)
...
def generateSpendingTrendsReport(userID, year=None):
    ...
    spending_trends_chart = app_dashboard.getSpendingTrends(userID, year)
    ...
    categories_active = app_categories.getSpendCategories(userID)
    ...
    categories_inactive = app_categories.getSpendCategories_Inactive(userID)
